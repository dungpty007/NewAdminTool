...
GO
PRINT N'Rename refactoring operation with key 143f8fab-82c6-4730-9fbb-609088576f28, 8656ac63-eae4-4a24-8641-e99872368cd5 is skipped, element [dbo].[ProfileInformation].[Address] (SqlSimpleColumn) will not be renamed to Address2';


GO
PRINT N'Altering [dbo].[AuditEvent]...';
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '143f8fab-82c6-4730-9fbb-609088576f28')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('143f8fab-82c6-4730-9fbb-609088576f28')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '8656ac63-eae4-4a24-8641-e99872368cd5')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('8656ac63-eae4-4a24-8641-e99872368cd5')
