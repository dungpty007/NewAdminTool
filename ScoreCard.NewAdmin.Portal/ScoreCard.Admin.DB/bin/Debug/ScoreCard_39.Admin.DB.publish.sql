...
GO
ALTER TABLE [dbo].[ExamLocation]
    ADD [Active] BIT NULL;


GO
PRINT N'Altering [dbo].[TrainingEventBooking]...';


GO
ALTER TABLE [dbo].[TrainingEventBooking]
    ADD [TrainingOutcome] BIT             NULL,
...
GO
ALTER TABLE [dbo].[TrainingEvent] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[TrainingEvent] WITH CHECK CHECK CONSTRAINT [FK_TrainingEvent_TrainingLocation];
