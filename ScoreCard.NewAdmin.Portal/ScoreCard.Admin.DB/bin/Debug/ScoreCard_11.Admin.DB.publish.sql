...
GO
/*
The type for column Type in table [dbo].[DocumentCategory] is currently  NVARCHAR (200) NULL but is being changed to  INT NULL. Data loss could occur.
*/

IF EXISTS (select top 1 1 from [dbo].[DocumentCategory])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Altering [dbo].[DocumentCategory]...';


GO
ALTER TABLE [dbo].[DocumentCategory] ALTER COLUMN [Type] INT NULL;
