...
GO
PRINT N'Dropping [dbo].[FK_ConflictOfInterest_Application]...';


GO
ALTER TABLE [dbo].[ConflictOfInterest] DROP CONSTRAINT [FK_ConflictOfInterest_Application];
...
ALTER TABLE [dbo].[AuditEvent]
    ADD [AdminRecommendationNote] NVARCHAR (MAX) NULL;
