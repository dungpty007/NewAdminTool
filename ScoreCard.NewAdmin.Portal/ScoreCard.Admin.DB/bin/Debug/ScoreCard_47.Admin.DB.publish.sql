...
GO
PRINT N'Starting rebuilding table [dbo].[EmailAttachFile]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_EmailAttachFile] (
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[EmailAttachFile])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_EmailAttachFile] ([Id], [ApplicationId], [FileName], [CreatedDate], [OwnerID], [AttachType], [Active], [CloudContainerName], [CloudID], [IsDefault])
        SELECT   [Id],
                 [ApplicationId],
                 [FileName],
                 [CreatedDate],
...
DROP TABLE [dbo].[EmailAttachFile];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_EmailAttachFile]', N'EmailAttachFile';
