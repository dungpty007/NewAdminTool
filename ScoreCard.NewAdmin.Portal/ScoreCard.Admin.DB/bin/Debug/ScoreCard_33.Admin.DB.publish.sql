...
GO
/*
The column [dbo].[ExamLocation].[DocumentID] is being dropped, data loss could occur.
*/

IF EXISTS (select top 1 1 from [dbo].[ExamLocation])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Dropping [dbo].[FK_ExamLocation_Document]...';


GO
ALTER TABLE [dbo].[ExamLocation] DROP CONSTRAINT [FK_ExamLocation_Document];


GO
PRINT N'Altering [dbo].[ExamLocation]...';


GO
ALTER TABLE [dbo].[ExamLocation] DROP COLUMN [DocumentID];
