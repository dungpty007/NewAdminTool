...
IF EXISTS (select top 1 1 from [dbo].[AuditEvent])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Rename refactoring operation with key 75d4d67b-fcaa-4ee4-8856-87af65453ebc is skipped, element [dbo].[QAEvent].[DateTime] (SqlSimpleColumn) will not be renamed to QADate';


GO
PRINT N'Dropping [dbo].[FK_CreateAuditEvent_Assessor]...';


GO
ALTER TABLE [dbo].[AuditEvent] DROP CONSTRAINT [FK_CreateAuditEvent_Assessor];


GO
PRINT N'Starting rebuilding table [dbo].[AuditEvent]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_AuditEvent] (
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[AuditEvent])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_AuditEvent] ([Id], [AuditDate], [Description], [Assessment], [Postcode], [Auditor], [Note])
        SELECT   [Id],
                 [AuditDate],
                 [Description],
                 [Assessment],
...
EXECUTE sp_rename N'[dbo].[tmp_ms_xx_AuditEvent]', N'AuditEvent';
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '75d4d67b-fcaa-4ee4-8856-87af65453ebc')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('75d4d67b-fcaa-4ee4-8856-87af65453ebc')
