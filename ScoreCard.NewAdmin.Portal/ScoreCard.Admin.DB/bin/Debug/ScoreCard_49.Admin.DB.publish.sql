...
GO
ALTER TABLE [dbo].[ExamEvent] ALTER COLUMN [AllocateExaminer] NVARCHAR (MAX) NOT NULL;

ALTER TABLE [dbo].[ExamEvent] ALTER COLUMN [ApplicantEmailAddress] NVARCHAR (MAX) NOT NULL;

ALTER TABLE [dbo].[ExamEvent] ALTER COLUMN [Venue] NVARCHAR (MAX) NOT NULL;
