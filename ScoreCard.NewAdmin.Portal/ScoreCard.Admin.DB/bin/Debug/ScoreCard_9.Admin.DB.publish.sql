...
GO
/*
The column [dbo].[IntermediaryAssessorDocument].[IntermediaryContent] is being dropped, data loss could occur.
*/
...
GO
ALTER TABLE [dbo].[IntermediaryAssessorDocument] DROP COLUMN [IntermediaryContent];
