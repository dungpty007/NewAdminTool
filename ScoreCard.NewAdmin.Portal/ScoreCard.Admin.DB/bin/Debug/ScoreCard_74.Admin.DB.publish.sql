...
GO
ALTER TABLE [dbo].[ExamEvent] ALTER COLUMN [Venue] NVARCHAR (MAX) NULL;
...
GO
ALTER TABLE [dbo].[ProfileInformation] ALTER COLUMN [Address] VARCHAR (500) NULL;

ALTER TABLE [dbo].[ProfileInformation] ALTER COLUMN [Address2] VARCHAR (500) NULL;

ALTER TABLE [dbo].[ProfileInformation] ALTER COLUMN [AddressLine1] VARCHAR (500) NULL;

ALTER TABLE [dbo].[ProfileInformation] ALTER COLUMN [AddressLine2] VARCHAR (500) NULL;

ALTER TABLE [dbo].[ProfileInformation] ALTER COLUMN [City] VARCHAR (500) NULL;

ALTER TABLE [dbo].[ProfileInformation] ALTER COLUMN [Organization] VARCHAR (500) NULL;

ALTER TABLE [dbo].[ProfileInformation] ALTER COLUMN [Website] VARCHAR (500) NULL;
