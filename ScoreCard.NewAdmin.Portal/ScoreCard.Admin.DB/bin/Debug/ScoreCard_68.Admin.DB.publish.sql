...
GO
PRINT N'Creating [dbo].[IntermediaryDocumentNote]...';
...
GO
PRINT N'Creating unnamed constraint on [dbo].[IntermediaryDocumentNote]...';


GO
ALTER TABLE [dbo].[IntermediaryDocumentNote]
    ADD DEFAULT NEWID() FOR [Id];


GO
PRINT N'Creating [dbo].[FK_IntermediaryDocumentNote_Intermediary]...';


GO
ALTER TABLE [dbo].[IntermediaryDocumentNote] WITH NOCHECK
    ADD CONSTRAINT [FK_IntermediaryDocumentNote_Intermediary] FOREIGN KEY ([IntemediaryId]) REFERENCES [dbo].[Intermediary] ([Id]);


GO
PRINT N'Creating [dbo].[FK_IntermediaryDocumentNote_Document]...';


GO
ALTER TABLE [dbo].[IntermediaryDocumentNote] WITH NOCHECK
    ADD CONSTRAINT [FK_IntermediaryDocumentNote_Document] FOREIGN KEY ([DocumentID]) REFERENCES [dbo].[Document] ([DocumentID]);
...
GO
ALTER TABLE [dbo].[IntermediaryDocumentNote] WITH CHECK CHECK CONSTRAINT [FK_IntermediaryDocumentNote_Intermediary];

ALTER TABLE [dbo].[IntermediaryDocumentNote] WITH CHECK CHECK CONSTRAINT [FK_IntermediaryDocumentNote_Document];
