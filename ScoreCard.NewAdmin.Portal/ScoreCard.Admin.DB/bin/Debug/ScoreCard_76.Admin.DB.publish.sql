...
GO
ALTER TABLE [dbo].[ProfileInformation] ALTER COLUMN [ContactPerson] VARCHAR (500) NULL;


GO
PRINT N'Starting rebuilding table [dbo].[QAEvent]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_QAEvent] (
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[QAEvent])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_QAEvent] ([Id], [QADate], [DemeritPoints], [Note], [UserId])
        SELECT   [Id],
                 [QADate],
                 [DemeritPoints],
                 [Note],
...
DROP TABLE [dbo].[QAEvent];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_QAEvent]', N'QAEvent';
