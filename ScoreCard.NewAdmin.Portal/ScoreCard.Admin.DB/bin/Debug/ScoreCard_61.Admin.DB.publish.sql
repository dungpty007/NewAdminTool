...
GO
PRINT N'Altering [dbo].[ApplicationDocument]...';
...
GO
PRINT N'Creating [dbo].[AuditEvent]...';
...
GO
PRINT N'Creating [dbo].[FK_CreateAuditEvent_Assessor]...';


GO
ALTER TABLE [dbo].[AuditEvent] WITH NOCHECK
    ADD CONSTRAINT [FK_CreateAuditEvent_Assessor] FOREIGN KEY ([AssessorId]) REFERENCES [dbo].[ProfileInformation] ([Id]);
...
GO
ALTER TABLE [dbo].[AuditEvent] WITH CHECK CHECK CONSTRAINT [FK_CreateAuditEvent_Assessor];
