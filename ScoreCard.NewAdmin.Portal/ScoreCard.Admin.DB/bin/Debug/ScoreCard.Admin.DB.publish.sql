...
GO
PRINT N'Creating unnamed constraint on [dbo].[DocumentLinks]...';
...
GO
PRINT N'Creating unnamed constraint on [dbo].[DocumentMetadata]...';


GO
ALTER TABLE [dbo].[DocumentMetadata]
    ADD DEFAULT (NEWID()) FOR [MetaDataID];


GO
PRINT N'Creating unnamed constraint on [dbo].[FileLocationDetails]...';
