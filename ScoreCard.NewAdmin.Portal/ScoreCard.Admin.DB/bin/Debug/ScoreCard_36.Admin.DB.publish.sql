...
--IF EXISTS (select top 1 1 from [dbo].[TrainingEvent])
--    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

--GO
PRINT N'Dropping [dbo].[FK_TrainingEventBooking_TrainingEvent]...';


GO
ALTER TABLE [dbo].[TrainingEventBooking] DROP CONSTRAINT [FK_TrainingEventBooking_TrainingEvent];


GO
PRINT N'Starting rebuilding table [dbo].[TrainingEvent]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_TrainingEvent] (
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_TrainingEvent] ([Id], [EventName], [EventType], [EventDate], [BookingClosingDate], [Description], [LocationId], [Capacity], [RoomNumber])
        SELECT   [Id],
                 [EventName],
                 [EventType],
                 [EventDate],
...
DROP TABLE [dbo].[TrainingEvent];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_TrainingEvent]', N'TrainingEvent';
...
GO
ALTER TABLE [dbo].[TrainingEventBooking] WITH NOCHECK
...
INSERT [dbo].[DocumentCategory] ([DocumentCategoryId], [Name], [ApplicationStage], [TrackExpiry], [Mandatory], [NeedsExpiryDate], [NeedsStartDate], [YearsRequired], [Note], [Type]) 
	VALUES (N'f28c2133-3ed2-430f-b070-515bfce61a11', N'Professional indemnity Ins', N'3', NULL, 0, 0, 0, NULL, N'Please record date of Expiry/Award under date column', 1);

INSERT [dbo].[DocumentCategory] ([DocumentCategoryId], [Name], [ApplicationStage], [TrackExpiry], [Mandatory], [NeedsExpiryDate], [NeedsStartDate], [YearsRequired], [Note], [Type]) 
	VALUES (N'c9be4035-ea9e-45bb-a74b-581d8aecf7ee', N'Safe Work Method Statement', N'3', NULL, 0, 0, 0, NULL, NULL, 1);
...
INSERT [dbo].[DocumentCategory] ([DocumentCategoryId], [Name], [ApplicationStage], [TrackExpiry], [Mandatory], [NeedsExpiryDate], [NeedsStartDate], [YearsRequired], [Note], [Type]) 
	VALUES (N'5fd76eaf-1437-4da2-8c38-a15e1b2229a6', N'Working with Children Card', N'3', NULL, 0, 0, 1, NULL, NULL, 1);

INSERT [dbo].[DocumentCategory] ([DocumentCategoryId], [Name], [ApplicationStage], [TrackExpiry], [Mandatory], [NeedsExpiryDate], [NeedsStartDate], [YearsRequired], [Note], [Type]) 
	VALUES (N'a61f5303-0c3d-49a8-b885-b2d73fb2a9e6', N'Assessor Agreement', N'5', NULL, 0, 0, 0, NULL, NULL, 1);
...
GO
ALTER TABLE [dbo].[TrainingEventBooking] WITH CHECK CHECK CONSTRAINT [FK_TrainingEventBooking_TrainingEvent];
