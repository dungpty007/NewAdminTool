...
GO
PRINT N'Altering [dbo].[AdminApplicationNotes]...';


GO
ALTER TABLE [dbo].[AdminApplicationNotes] ALTER COLUMN [UserId] UNIQUEIDENTIFIER NULL;
...
GO
PRINT N'Creating unnamed constraint on [dbo].[GeographicRegion]...';
