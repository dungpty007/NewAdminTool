...
GO
PRINT N'Creating [dbo].[RegionLGAAssessor]...';


GO
CREATE TABLE [dbo].[RegionLGAAssessor] (
    [AssessorId]  UNIQUEIDENTIFIER NOT NULL,
    [RegionLGAId] UNIQUEIDENTIFIER NOT NULL,
    CONSTRAINT [PK_RegionLGAAssessor] PRIMARY KEY CLUSTERED ([AssessorId] ASC, [RegionLGAId] ASC)
);


GO
PRINT N'Creating [dbo].[RegionsLGA]...';
...
GO
PRINT N'Creating unnamed constraint on [dbo].[RegionLGAAssessor]...';


GO
ALTER TABLE [dbo].[RegionLGAAssessor]
    ADD DEFAULT NEWID() FOR [AssessorId];
...
GO
ALTER TABLE [dbo].[RegionLGAAssessor]
    ADD DEFAULT NEWID() FOR [RegionLGAId];


GO
PRINT N'Creating unnamed constraint on [dbo].[RegionsLGA]...';


GO
ALTER TABLE [dbo].[RegionsLGA]
    ADD DEFAULT NEWID() FOR [Id];


GO
PRINT N'Creating [dbo].[FK_RegionLGAAssessor_RegionsLGA]...';


GO
ALTER TABLE [dbo].[RegionLGAAssessor] WITH NOCHECK
    ADD CONSTRAINT [FK_RegionLGAAssessor_RegionsLGA] FOREIGN KEY ([RegionLGAId]) REFERENCES [dbo].[RegionsLGA] ([Id]);
...
GO
ALTER TABLE [dbo].[RegionLGAAssessor] WITH CHECK CHECK CONSTRAINT [FK_RegionLGAAssessor_RegionsLGA];
