...
IF EXISTS (select top 1 1 from [dbo].[AdminApplicationNotes])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Dropping unnamed constraint on [dbo].[AdminApplicationNotes]...';


GO
ALTER TABLE [dbo].[AdminApplicationNotes] DROP CONSTRAINT [DF__AdminApplica__Id__5812160E];


GO
PRINT N'Dropping [dbo].[FK_AdminApplicationNotes_Application]...';


GO
ALTER TABLE [dbo].[AdminApplicationNotes] DROP CONSTRAINT [FK_AdminApplicationNotes_Application];


GO
PRINT N'Starting rebuilding table [dbo].[AdminApplicationNotes]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_AdminApplicationNotes] (
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[AdminApplicationNotes])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_AdminApplicationNotes] ([Id], [NoteAddedDate], [Note], [ApplicationId])
        SELECT   [Id],
                 [NoteAddedDate],
                 [Note],
                 [ApplicationId]
...
DROP TABLE [dbo].[AdminApplicationNotes];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_AdminApplicationNotes]', N'AdminApplicationNotes';
...
GO
ALTER TABLE [dbo].[AdminApplicationNotes] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[AdminApplicationNotes] WITH CHECK CHECK CONSTRAINT [FK_AdminApplicationNotes_Application];
